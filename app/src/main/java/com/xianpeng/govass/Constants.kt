...
class Constants {
    companion object {
        ...
        //全局搜索
        const val GET_GLOBAL_SEARCH_RESULT =
            "$BASE_IP/govass/sys/common-search/list?page=1&limit=100&query="
        ...
        //修改分组
        const val POST_UPDATE_GROUP = "$BASE_IP/govass/sys/group/update"

        //删除分组
        const val POST_DELETE_GROUP = "$BASE_IP/govass/sys/group/delete"
